 ...
 *
 * @author 二师兄超级帅
 * @date 2019/3/7 17:00 2018/8/30 11:45
 */
@Component
@Slf4j
public class JwtUtil {
     ...
     * @return boolean 是否正确
     * @author 二师兄超级帅
     * @date 2019/3/7 17:00 2018/8/31 9:05
     */
    public static boolean verify(String token) {
        try {
            ...
            throw new BizException(ErrorEnum.JWT_ERROR);
        }
    }
     ...
     * @author 二师兄超级帅
     * @date 2019/3/7 17:00 2018/9/7 16:54
     */
     ...
     * @author 二师兄超级帅
     * @date 2019/3/7 17:00 2018/8/31 9:07
     */
